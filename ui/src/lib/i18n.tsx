...
const translations: Record<string, Record<Locale, string>> = {
  ...
  'kroger.add_all': { en: '🛒 Match Ingredients on Kroger', es: '🛒 Buscar Ingredientes en Kroger' },
  'kroger.adding': { en: '⏳ Matching ingredients...', es: '⏳ Buscando ingredientes...' },
  'kroger.items': { en: 'matched items', es: 'artículos encontrados' },
  'kroger.open_cart': { en: '🛒 Review Kroger Cart', es: '🛒 Revisar Carrito Kroger' },
  'kroger.open_cart_short': { en: 'Cart', es: 'Carrito' },
  'kroger.not_found': { en: 'Not found', es: 'No encontrado' },
  'kroger.tap_item': { en: 'Tap each matched item to add it to your Kroger cart', es: 'Toca cada artículo para agregarlo a tu carrito de Kroger' },
  'kroger.auto_match': { en: 'Matches each ingredient to a Kroger product — tap each one to add to your cart', es: 'Empareja cada ingrediente con un producto de Kroger — toca cada uno para agregar al carrito' },
